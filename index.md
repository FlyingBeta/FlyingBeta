...
<head>
    ...
    <title>学生生活服务网上预约系统</title>
    <style>
        #app {
            font-family: "\5B8B\4F53",Avenir,Helvetica,Arial,sans-serif;
        ...
        .noticeBar {
            ...
            padding: 10px;
            border: 0;
            -webkit-box-shadow: 0 0 8px #ada3ad;
            box-shadow: 0 0 8px #ada3ad
        }
        ...
        .foodCard>.van-checkbox__label {
            width: 100%
        }

        .list-content[data-v-652b0518] {
            margin-top: 0;
            overflow: scroll
        }

        .list-content[data-v-3ebdfaac] {
            border-radius: 10px;
            margin: 10px;
            padding: 20px;
        ...
        .shadow[data-v-3ebdfaac] {
            -webkit-box-shadow: 1px 1px 3px #ada3ad;
            box-shadow: 1px 1px 3px #ada3ad
        }

        .content[data-v-7199ff8c] {
            text-align: center
        }

        .bottom-button[data-v-7199ff8c] {
            width: 160px
        }

        .list-content[data-v-7199ff8c] {
            margin-top: 0;
            overflow: scroll
        }

        .dateCss[data-v-7199ff8c] {
            background: #f0efef
        }

        .content[data-v-3ae1f9fc] {
            text-align: center
        }

        .bottom-button[data-v-3ae1f9fc] {
            width: 160px
        }

        .list-content[data-v-3ae1f9fc] {
            margin-top: 0;
            overflow: scroll
        }

        .dateCss[data-v-3ae1f9fc] {
            background: #f0efef
        }

        .bottom-button[data-v-ad7d3118] {
            width: 160px
        }

        .list-content[data-v-ad7d3118] {
            margin-top: 0;
            overflow: scroll
        }

        .bottom-button[data-v-48bf4c5a] {
            width: 160px
        }

        .list-content[data-v-48bf4c5a] {
            margin-top: 0;
            overflow: scroll
        }
        ...
        .bottom-button[data-v-0ea9796a] {
            width: 160px
        }

        .list-content[data-v-0ea9796a] {
            margin-top: 0;
            position: absolute;
            width: 100%;
            overflow: scroll
        ...
        .bottom-button[data-v-0bee0a0e] {
            width: 160px
        }

        .list-content[data-v-0bee0a0e] {
            margin-top: 0;
            position: absolute;
            width: 100%;
            overflow: scroll
        ...
        .bottom-button[data-v-05dd1ae4] {
            width: 160px
        }

        .list-content[data-v-05dd1ae4] {
            margin-top: 0;
            position: absolute;
            width: 100%;
            overflow: scroll
        ...
        .color1[data-v-39a4b29d] {
            background: radial-gradient(circle at 70% 30%,transparent,#add8e6);
            background: -moz-radial-gradient(circle at 70% 30%,transparent,#add8e6)
        }

        .color2[data-v-39a4b29d] {
            background: radial-gradient(circle at 30% 70%,transparent,#add8e6);
            background: -moz-radial-gradient(circle at 30% 70%,transparent,#add8e6)
        }

        .label[data-v-39a4b29d] {
            color: #969799;
            width: 65px;
        ...
        .van-cell__value[data-v-9b9dde92] {
            -webkit-box-flex: 2;
            -ms-flex: 2;
            flex: 2
        }

        .xuehao>.van-cell__value>.van-field[data-v-9b9dde92] {
            padding-bottom: 0;
            padding-top: 0;
            padding-right: 0
        }
        ...
        .van-share-sheet__options:after {
            display: block;
            -webkit-flex-shrink: 0;
            flex-shrink: 0;
            width: 24px;
...
<div id="app">
        ...
        <form action="">
            <table>
                <tr>
                    ...
                    <td>
                        <select name="" id="place">
                            <option value="3">南院男浴室</option>
                            <option value="1">北院男浴室</option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="" id="time">
                            <option value=10>17:30 - 17:35</option>
                            <option value=11>18:00 - 18:05</option>
                            <option value=12>18:30 - 18:35</option>
                            <option value=13>19:00 - 19:05</option>
                            <option value=14>19:30 - 19:35</option>
                            <option value=15>20:00 - 20:05</option>
                            <option value=16>20:30 - 20:35</option>
    ...
    <div class="_page2" style="display: none;height: 100%;">
        <div style="position: fixed; top: 0px; right: 0px; left: 0px; bottom: 50px;">
            <div class="van-tabs van-tabs--line">
                <div class="van-tabs__wrap van-hairline--top-bottom">
                    <div role="tablist" class="van-tabs__nav van-tabs__nav--line">
                        <div role="tab" class="van-tab van-ellipsis">
         <span class="van-tab__text">未完成
             <!----></span>
                        </div>
                        <div role="tab" class="van-tab van-ellipsis">
         <span class="van-tab__text">已完成
             <!----></span>
                        </div>
                        <div role="tab" class="van-tab van-tab--active van-ellipsis" aria-selected="true">
         <span class="van-tab__text">全部
             <!----></span>
                        </div>
                        <div class="van-tabs__line" style="width: 256px; transform: translateX(1280px) translateX(-50%); transition-duration: 0.3s;"></div>
                    </div>
                </div>
                <div class="van-tabs__content">
                    <div role="tabpanel" class="van-tab__pane" style="display: none;">
                        <div data-v-0ea9796a="">
                            <div data-v-0ea9796a="" id="list-content-unfinish" class="list-content" style="height: 663px;">
                                <div data-v-0ea9796a="" class="van-pull-refresh">
                                    <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                                        <div class="van-pull-refresh__head"></div>
                                        <ul data-v-0ea9796a=""></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div role="tabpanel" class="van-tab__pane" style="">
                        <div data-v-05dd1ae4="">
                            <div data-v-05dd1ae4="" id="list-content-all" class="list-content" style="height: 663px;">
                                <div data-v-05dd1ae4="" class="van-pull-refresh">
                                    <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                                        <div class="van-pull-refresh__head"></div>
                                        <div data-v-39a4b29d="" data-v-05dd1ae4="" class="item color1">
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: left; width: 100%;">
                                                        <span data-v-39a4b29d="" class="label">预约码：</span>
                                                        <span data-v-39a4b29d="" style="color: rgb(255, 0, 0);">3-15-1075</span>
                                                    </div>
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: right; color: rgb(255, 200, 41);">
                                                        待完成
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">类型：</span>洗浴
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span  data-v-39a4b29d="" class="label">地点：</span>南院男浴室
                                                </div>
                                            </div>
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">日期：</span>2020-09-20
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">时间：</span>20:00 - 20:05
                                                </div>
                                            </div>
                                            <!---->
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12"></div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12"></div>
                                            </div>
                                        </div>
                                        <div data-v-39a4b29d="" data-v-05dd1ae4="" class="item color2">
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: left; width: 100%;">
                                                        <span data-v-39a4b29d="" class="label">预约码：</span>
                                                        <span data-v-39a4b29d="" style="color: rgb(255, 0, 0);">3-1-1042</span>
                                                    </div>
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: right; color: rgb(255, 200, 41);">
                                            ...
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">日期：</span>2020-09-19
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">时间：</span>12:00 - 12:05
                                                </div>
                                            </div>
                                            <!---->
                                            <div data-v-39a4b29d="" class="van-row">
                                        ...
                                        <div data-v-39a4b29d="" data-v-05dd1ae4="" class="item color1">
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: left; width: 100%;">
                                                        <span data-v-39a4b29d="" class="label">预约码：</span>
                                                        <span data-v-39a4b29d="" style="color: rgb(255, 0, 0);">3-18-1089</span>
                                                    </div>
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: right; color: rgb(255, 200, 41);">
                                            ...
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">日期：</span>2020-09-18
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">时间：</span>11:00 - 11:05
                                                </div>
                                            </div>
                                            <!---->
                                            <div data-v-39a4b29d="" class="van-row">
                                        ...
                                        <div data-v-39a4b29d="" data-v-05dd1ae4="" class="item color2">
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: left; width: 100%;">
                                                        <span data-v-39a4b29d="" class="label">预约码：</span>
                                                        <span data-v-39a4b29d="" style="color: rgb(255, 0, 0);">3-11-1064</span>
                                                    </div>
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <div data-v-39a4b29d="" style="float: right; color: rgb(255, 200, 41);">
                                            ...
                                            <div data-v-39a4b29d="" class="van-row">
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">日期：</span>2020-09-17
                                                </div>
                                                <div data-v-39a4b29d="" class="van-col van-col--12">
                                                    <span data-v-39a4b29d="" class="label">时间：</span>18:00 - 18:05
                                                </div>
                                            </div>
                                            <!---->
                                            <div data-v-39a4b29d="" class="van-row">
        ...
        <div class="van-hairline--top-bottom van-tabbar van-tabbar--fixed" style="height: 50px;">
            <div class="van-tabbar-item" style="color: rgb(0, 0, 0);">
                <div class="van-tabbar-item__icon">
                    <i class="van-icon van-icon-apps-o">
                        <!----></i>
                    <!---->
                </div>
            ...
            <div class="van-tabbar-item" style="color: rgb(0, 0, 0);">
                <div class="van-tabbar-item__icon">
                    <i class="van-icon van-icon-shop-collect">
                        <!----></i>
                    <!---->
                </div>
                <div class="van-tabbar-item__text">
            ...
            <div class="van-tabbar-item van-tabbar-item--active" style="color: rgb(7, 193, 96);">
                <div class="van-tabbar-item__icon">
                    <i class="van-icon van-icon-bill">
                        <!----></i>
                    <!---->
                </div>
                <div class="van-tabbar-item__text">
        ...
        <div data-v-9b9dde92=""></div>
    </div>
</div>

<!---->
<div class="van-overlay _page2" style="display: none;z-index: 2001;"></div>
<div data-v-39a4b29d="" role="dialog" class="van-dialog _page2" style="display: none;z-index: 2002;">
    <div class="van-dialog__content">
        <div data-v-39a4b29d="">
            <div style="text-align: center; color: rgb(0, 0, 255); font-size: 18px; padding: 10px 0px;">
                订单详情
            </div>
            <!---->
            <div class="van-cell-group van-hairline--top-bottom">
                <div class="van-cell" style="padding: 5px 16px;">
                    <div class="van-cell__title">
                        <span>姓名</span>
                    </div>
                    <div class="van-cell__value">
                       <span id="_person">王侯</span>
                    </div>
				</div>
				<div class="van-cell" style="padding: 5px 16px;">
                    <div class="van-cell__title">
                ...
                <div class="van-cell" style="padding: 5px 16px;">
                    ...
                    <div class="van-cell__value">
                        <canvas id="_date" style="height: 26px; width: 144px;"></canvas>
                    </div>
                </div>
                <div class="van-cell" style="padding: 5px 16px;">
                    <div class="van-cell__title">
                    ...
                    <div class="van-cell__value">
                        <canvas id="_time" style="height: 26px;width: 144px;"></canvas>
                    </div>
                </div>
                <!---->
                <!---->
            ...
            <div>
                <div class="van-cell-group__title">
                    <div style="text-align: center;">
                        <span style="color: rgb(0, 0, 255); font-size: 18px;">预约码</span>
                    </div>
                </div>
                <div class="van-cell-group van-hairline--top-bottom">
                    <canvas id="_code" style="height: 120px; width: 300px;"></canvas>
                </div>
            </div>
            <div style="color: rgb(0, 0, 0); font-size: 12px; text-align: center; margin: 10px;">
                请按时到场，
                <span style="color: rgb(255, 0, 0); font-size: 16px;">过时作废，需重新预约！！！</span>
            </div>
        </div>
    </div>
    <div class="van-hairline--top van-dialog__footer">
        <button class="van-button van-button--default van-button--large van-dialog__confirm"><span class="van-button__text">确认</span></button>
    </div>
</div>
...
<script>
    function venderCode(code, date, time) {
        color = randomColor();
        var c=document.getElementById("_code");
        var ctx=c.getContext("2d");
        ctx.font="bold 50px/20px Arial";
        ctx.textAlign = "center";
        ctx.fillStyle = color;
        ctx.fillText(code,155,85);

        var d = document.getElementById('_date');
        var ctx_d = d.getContext('2d');
        ctx_d.width = 144;
        ctx_d.height = 26;
        ctx_d.font = "bold 120px/40px Arial";
        ctx_d.fillStyle = color;
        ctx_d.fillText(date, 146, 120, 150);

        var t = document.getElementById("_time");
        var ctx_t = t.getContext("2d");
        ctx_t.font = "bold 120px/40px Arial";
        ctx_t.fillStyle = color;
        ctx_t.fillText(time, 100, 120, 200);
    }
    ...
    function submit(){
        ...
        if(place==1){
            document.getElementById('_place').innerText = "北院男浴室";
        }else{
            document.getElementById('_place').innerText = "南院男浴室";
        }
		
		person = document.getElementById('person').value;
		document.getElementById('_person').innerText = person;
		
		college = document.getElementById('college').value;
		document.getElementById('_college').innerText = college;
        
        _t = document.getElementById('time').value;
        time = arr[_t];
       code = place+"-"+_t+"-"+random(1001, 1120);
        date = document.getElementById('date').value;
        document.getElementById('form').style.display="none";
        shows = document.getElementsByClassName('_page2');
        for (let item of shows){
            item.style.display = "block";
        }
        setInterval("venderCode(code, date, time)", 600);
    }
